...
sibling modules — ``OpenAI`` in :mod:`kaggle_benchmarks.actors.proxy_openai`
and ``GoogleGenAI`` in :mod:`kaggle_benchmarks.actors.proxy_genai` — and are
...
from kaggle_benchmarks.actors.proxy_genai import GoogleGenAI  # noqa: E402
from kaggle_benchmarks.actors.proxy_openai import OpenAI  # noqa: E402
